...
public class Trap extends Gelaendetyp{
	...
	static{
		try{
			bimg = ImageIO.read(Tile.class.getClassLoader().getResourceAsStream("gfx/Tiles/trap.png"));
